...
function Landing() {
  return (
    <>
      ...
      <section className=" w-full bg-header-image  py-5 md:py-36 max-w-full h-auto">
        <div className=" container text-white flex flex-col justify-center items-center gap-y-12">
          ...
          <form className="hidden md:flex bg-white w-[700px] py-7 px-5 justify-between items-center  text-black h-full relative rounded-xl">
            ...
            <button className="bg-green-primery w-16 h-16  flex justify-center items-center child:size-10 flex-shrink-0 text-white rounded-lg absolute left-4 ">
              <FaSearch />
            </button>
          </form>
